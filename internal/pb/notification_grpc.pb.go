...
type NotificationServiceClient interface {
	SendNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *notificationServiceClient) SendNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type NotificationServiceServer interface {
	SendNotification(context.Context, *Notification) (*Status, error)
...
func (UnimplementedNotificationServiceServer) SendNotification(context.Context, *Notification) (*Status, error) {
